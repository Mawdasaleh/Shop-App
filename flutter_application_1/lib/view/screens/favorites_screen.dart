...
import 'package:flutter_application_1/view/widgets/home/card_items.dart';
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'please, Add your favourites productes',
                  style: TextStyle(
                    fontSize: 18,
          ...
          return ListView.separated(
            itemBuilder: (context, index) {
              return buildFavItems(
                ...
                proid: controller.favouritesList[index].id!,
              );
            },
      ...
      child: SizedBox(
        ...
        child: Row(
          children: [
            ...
            IconButton(
                onPressed: () {
                  controller.managefavourites(proid);
                },
                icon: const Icon(
                  Icons.favorite,
                  color: Colors.red,
